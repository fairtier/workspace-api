...
type CheckResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// True if the service and all dependencies are operational.
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\thealth.v1\"\x0e\n" +
	"\fCheckRequest\"C\n" +
	"\rCheckResponse\x12\x18\n" +
	"\ahealthy\x18\x01 \x01(\bR\ahealthy\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2M\n" +
	"\rHealthService\x12<\n" +
	"\x05Check\x12\x17.health.v1.CheckRequest\x1a\x18.health.v1.CheckResponse\"\x00B<Z:github.com/fairtier/workspace-api/proto/health/v1;healthv1b\x06proto3"
