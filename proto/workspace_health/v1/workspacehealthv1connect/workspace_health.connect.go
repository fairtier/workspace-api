...
package workspacehealthv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/fairtier/workspace-api/proto/workspace_health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "workspace_health.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/workspace_health.v1.HealthService/Check"
)

// HealthServiceClient is a client for the workspace_health.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the workspace_health.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_workspace_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls workspace_health.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the workspace_health.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/workspace_health.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("workspace_health.v1.HealthService.Check is not implemented"))
}
